...
module.exports = function() {
	...
	//To determine the sum of prime number from 1 to the number inclusive.
	function sum_of_primes(n)
	{
	    var sum = 0;
	    //Calculates the sum of the prime numbers between 1 and the number inclusive.
	    for (var i = n; i >=2; i--)
	    {
	        if (check_prime_number(i) == true)
	        {
	        	//adds the value to the sum if its prime
	            sum += i;
	        }
	    }
	    return sum;
